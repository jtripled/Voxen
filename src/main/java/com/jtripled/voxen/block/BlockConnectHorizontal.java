 ...
 * @author jtripled
 */
public abstract class BlockConnectHorizontal extends BlockBase
{
    ...
    public BlockConnectHorizontal(String name, Material material)
    {
        this(name, material, material.getMaterialMapColor());
    }
    
    public BlockConnectHorizontal(String name, Material material, MapColor mapColor)
    {
