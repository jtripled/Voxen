 ...
 * @author jtripled
 */
public abstract class BlockPane extends BlockBase implements IBlockConnectable.Horizontal
{
    ...
    public BlockPane(String name, Material material, MapColor color)
    {
